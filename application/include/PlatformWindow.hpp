...
public:
    ...
    using cursor_pos_callback_t = std::function<void(double pos_x, double pos_y)>;
    using cursor_enter_callback_t = std::function<void(int enter)>;
    using scroll_callback_t = std::function<void(double scroll_x, double scroll_y)>;
    using char_callback_t = std::function<void(unsigned int code_point)>;
    using path_drop_callback_t = std::function<void(int count, const char** paths)>;
    using mouse_button_callback_t = std::function<void(int button, int action, int mods)>;
    using keyboard_key_callback_t = std::function<void(int key, int scancode, int action, int mods)>;
